...
print '
    <link rel="stylesheet" type="text/css" href="/css/omeyverse2.css">';
global $nnecnojs;
if(!isset($nnecnojs)) { print '
<script src="/js/offdevice/omeyverse.js"></script>'; } print '<style type="text/css"></style>
...
function printFooter($mode) {
  ...
  global $dev_server;
  print '            <p id="copyright">Omeyverse' . ($dev_server == true ? '/' . $version . ' (offdevice)' : '') . '</p>';
  // New anchor link added here
  echo '<div id="header-news">
  <div class="image-icon"></div>
  <a href="/titles/' . htmlspecialchars($acomm["olive_title_id"]) . '/111111/111111' . htmlspecialchars($acomm["olive_community_id"]) . '" class="header-news-button" data-pjax="#body">' . loc("grp.portal.new_announcement") . '</a>
